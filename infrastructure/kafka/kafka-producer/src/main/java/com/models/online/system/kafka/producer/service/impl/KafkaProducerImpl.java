package com.models.online.system.kafka.producer.service.impl;

import com.models.online.system.kafka.producer.exception.KafkaProducerException;
...
public class KafkaProducerImpl<K extends Serializable, V extends SpecificRecordBase> implements KafkaProducer<K, V> {
    ...
    public void send(String topicName, K key, V message, CompletableFuture<SendResult<K, V>> callback) {
        ...
        try {
            ...
            kafkaResultFuture.complete(callback);
