...
public class DownloadCreateCommandHandler {
    ...
    public DownloadCreateCommandHandler(DownloadDomainService downloadDomainService,
    ...
    public CreateDownloadResponse createDownload(CreateDownloadCommand createDownloadCommand) {
        ...
        Download downloadResult = saveDownload(download);
        log.info("Download is created whit id: {}",downloadResult.getId().getValue());
        return downloadDataMapper.createDownloadResponse(downloadResult);
    }
